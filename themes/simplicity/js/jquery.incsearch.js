(function($) {
	var IncrementalSearch = function(params){
		...
		if(setting.foundCounter){
			...
			this.foundCounter = new IncrementalSearch.Counter(setting);
		}
		this.formerQuery = '';
		this.itemData = [];
		this.init();
	...
	IncrementalSearch.prototype = {
		...
		makeData: function(){
			...
			this.items.each(function(){
				...
				that.itemData.push(new IncrementalSearch.SearchedItem(obj,that.setting));
			})
	 ...
	 *@param obj {array}
	 **/
	IncrementalSearch.SearchedItem = function(obj,setting){
	...
	IncrementalSearch.SearchedItem.prototype = {
		hideItem: function(){
	...
	IncrementalSearch.Counter = function(setting){
	...
	$.fn.incrementalSearch = function(params){
		return this.each(function(){
			if(typeof params == 'string' || params.size){
				new IncrementalSearch({input:$(this),items:params})
			}else if(typeof params == 'object'){
				params.input = $(this);
				new IncrementalSearch(params)
			}
		});
	};
})(jQuery);
