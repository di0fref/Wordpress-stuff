...
<?php if ($comments) : ?>
    ...
    <?php foreach ($comments as $comment) : ?>
        ...
        <li <?php echo $oddcomment; ?> id="comment-<?php comment_ID() ?>">
            <cite><?php echo get_avatar( $comment, 32 ); ?><?php comment_author_link() ?></cite> Says:
    ...
    <?php /* Changes every other comment to a different class */
        if (!empty($oddcomment)) $oddcomment = '';
...
?>
    <p>
    <strong>Please note:</strong> Comment moderation is currently enabled so
    there will be a <strong>delay</strong> between when you post your comment and
    when it shows up. Patience is a virtue; there&#8217;s <strong>no need to
    re-submit</strong> your comment.
    </p>
<?php
...
<p><textarea name="comment" id="comment" style="width:38em" cols="65" rows="10" tabindex="4"></textarea></p>
